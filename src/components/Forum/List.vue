...
const fetchNews = async (page = 1, limit = 10) => {
    const data = [
        ...
        { id: 6, title: "Game Anniversary Celebration 🎉", avatar: "/src/assets/forum/6.jpg", author: "GameStudio", publish_time: random_timestamp(2), replies: 25, views: "6K" },
        { id: 7, title: "Top 10 Game Recommendations for 2024 🏆", avatar: "/src/assets/forum/7.jpg", author: "GameCritic", publish_time: random_timestamp(1), replies: 10, views: "4K" },
        { id: 8, title: "Player Spotlight: The Pro Gamer 🥇", avatar: "/src/assets/forum/8.jpg", author: "ProPlayer", publish_time: random_timestamp(2), replies: 20, views: "3.5K" },
        { id: 9, title: "What’s New in Version 2.0 🚀", avatar: "/src/assets/forum/9.jpg", author: "TechDev", publish_time: random_timestamp(4), replies: 5, views: "1K" },
        { id: 10, title: "Holiday Event Returns! 🎄", avatar: "/src/assets/forum/10.jpg", author: "FestiveFan", publish_time: random_timestamp(3), replies: 50, views: "9K" },
    ];
